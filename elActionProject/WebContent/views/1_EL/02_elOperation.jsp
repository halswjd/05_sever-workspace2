...
>>>>>>> 2791e74f934b8f27c9b1ab54ba06e27f02708697
	...
	10 &gt; 3 = ${ big > small } 또는 ${ big gt small } <br> <!-- true 출력 -->
	10 &lt; 3 = ${ big < small } 또는 ${ big lt small } <br> <!-- false 출력 -->
	10 &gt;= 3 = ${ big >= small } 또는 ${ big ge small } <br> <!-- true 출력 -->
	10 &lt;= 3 = ${ big <= small } 또는 ${ big le small } <br><br> <!-- false 출력 -->
	
	<h3>3. 동등 비교 연산</h3>
	
	<!-- el에서의 == 비교는 자바에서의 equals()와 같은 동작을 함    ↓ 이 수식을 더 선호 -->
	sOne과 sTwo이 일치합니까? : ${ sOne == sTwo } 또는 ${ sOne eq sTwo } <br>
	sOne과 sTwo가 일치하지 않습니까? : ${ sOne != sTwo } 또는 ${ sOne ne sTwo }<br><br>
	
	big에 담긴 값이 10과 일치합니까? : ${ big == 10 } 또는 ${ big eq 10 } <br>
	sOne에 담긴 값이 "안녕"과 일치합니까? : ${ sOne == '안녕' } 또는 ${ sOne eq "안녕" } <!-- 큰따옴표와 작은따옴표 구분 X --><br><br>
	<!-- el안에서 문자열 리터럴 제시시 홑따옴표든 쌍따옴표든 가리지 않음 -->
	...
	lTow가 텅비어있습니까? : ${ empty lTwo } <br><br>	
